...
EspectroAudible.prototype = Object.assign(
  Object.create(ObjetoCanvas.prototype),
  {
    ...
    MouseMove: function (Evento) {
      ...
      if (
        this.Pantalla.Hover === true ||
        this.Pantalla2.Hover === true ||
        this.Pantalla3.Hover === true ||
        this.C_Atras.Hover === true ||
        this.C_Play.Hover === true ||
        this.C_Adelante.Hover === true ||
        this.BarrasAnalizador.Hover === true ||
        this.C_BarraTiempo.Hover === true ||
        this.C_SliderTiempo.Hover === true ||
        this.DatosCancion.Hover === true
      ) {
    ...
    MouseSoltado: function (Evento) {
      if (this.Pantalla.Hover === true) {
        this.TipoPantalla++;
        if (this.TipoPantalla > this.FuncionesPintarPantalla.length - 1) {
          this.TipoPantalla = 0;
        }
      }
      if (this.Pantalla2.Hover === true) {
        this.TipoPantalla2++;
        if (this.TipoPantalla2 > this.FuncionesPintarPantalla.length - 1) {
          this.TipoPantalla2 = 0;
        }
      }
      if (this.Pantalla3.Hover === true) {
        this.TipoPantalla3++;
        if (this.TipoPantalla3 > this.FuncionesPintarPantalla.length - 1) {
          this.TipoPantalla3 = 0;
        }
      }
      ...
      if (this.BarrasAnalizador.Hover === true) {
        ...
        if (this.PrecisionAnalizador === 0) {
          this.ReIniciarCubos(32);
        }
        if (this.PrecisionAnalizador === 1) {
          this.ReIniciarCubos(16);
        }
        if (this.PrecisionAnalizador === 2) {
          this.ReIniciarCubos(8);
        }
      }

      if (this.C_BarraTiempo.Hover === true) {
        var ct =
          (this.Audio.Cancion.duration / this.AnchoBarraTiempo) *
          this.C_BarraTiempo.PosHover;
    ...
    TouchStart: function (Evento) {
      ...
      this.PosMouse.y =
        -(Evento.touches[0].clientY / window.innerHeight) * 2 + 1;
    ...
    Iniciar: function () {
      ...
      this.Camara.Rotacion = {
        Grados: 97 * this.Constantes.Radiant,
        Avance: this.Constantes.Radiant / 5,
        Distancia: 40,
        MirarHacia: new THREE.Vector3(0, 5, 0),
      };
      this.Camara.position.set(
        this.Camara.Rotacion.Distancia * Math.cos(this.Camara.Rotacion.Grados),
        30,
      ...
      this.Suelo = new THREE.Mesh(
        new THREE.BoxGeometry(160, 40, 130),
        new THREE.MeshPhongMaterial({
          color: this.Colores.Suelo,
          specular: 0xeeeeee,
        })
      );
      ...
      this.SueloAnalizador = new THREE.Mesh(
        new THREE.BoxGeometry(32, 0.6, 32),
        new THREE.MeshPhongMaterial({
          color: this.Colores.Suelo,
          specular: 0xeeeeee,
        })
      ...
      this.C_Atras = new THREE.Mesh(
        new THREE.BoxGeometry(3, 1, 3),
        new THREE.MeshPhongMaterial({
          color: this.Colores.Controles,
          specular: 0xeeeeee,
        })
      );
      this.C_Atras.position.set(-4, 0.2, -2.5);
      this.Controles.add(this.C_Atras);
      this.C_Play = new THREE.Mesh(
        new THREE.BoxGeometry(3, 1, 3),
        new THREE.MeshPhongMaterial({
          color: this.Colores.Controles,
          specular: 0xeeeeee,
      ...
      this.C_Adelante = new THREE.Mesh(
        new THREE.BoxGeometry(3, 1, 3),
        new THREE.MeshPhongMaterial({
          color: this.Colores.Controles,
          specular: 0xeeeeee,
      ...
      this.C_BarraTiempo = new THREE.Mesh(
        new THREE.BoxGeometry(this.AnchoBarraTiempo, 1, 1),
        new THREE.MeshPhongMaterial({
          color: this.Colores.Controles,
          specular: 0xeeeeee,
        })
      ...
      this.C_SliderTiempo = new THREE.Mesh(
      ...
      this.PrecisionAnalizador = this.Audio.Iniciar(
        ObjetoNavegador.EsMovil(),
        this,
        function () {
          this.CancionCargada();
        }.bind(this), // Función CanPlay
        this.CancionTerminada.bind(this)
      ); // Función Ended
    ...
    CrearTexturasBotones: function () {
      ...
      for (var i = 0; i < 4; i++) {
        ...
        this.BufferIcosTextura[i] = new THREE.Texture(
          this.BufferIcos[i].Canvas
        );
      }

      // Icono Atras
      this.PintarTrianguloRedondeado(
        this.BufferIcos[0].Context,
        92,
        64,
        38,
        270,
      ...
      this.PintarRectanguloRedondeado(
        this.BufferIcos[0].Context,
        14,
        30,
        22,
      ...
      for (var i = 0; i < 4; i++) {
        ...
        this.PlanoTextura[i].position.y = 0.55;
      }
    ...
    ActualizarTiempoSlider: function () {
      ...
      // Posición del slider
      this.C_SliderTiempo.position.x =
        -(this.AnchoBarraTiempo / 2) + this.Audio.Cancion.currentTime * Parte;

      this.BufferSlider.Context.clearRect(
        0,
        0,
        this.BufferSlider.Ancho,
        this.BufferSlider.Alto
      );
    ...
    PintarTrianguloRedondeado: function (
      Context,
      PosX,
      PosY,
      Tam,
    ...
    PintarRectanguloRedondeado: function (
      Context,
      PosX1,
      PosY1,
      PosX2,
    ...
    ReIniciarCubos: function (TamLado) {
      ...
      for (var i = 0; i < this.Cubos.length; i++) {
        this.BarrasAnalizador.remove(this.Cubos[i]);
      }
    ...
    MediaFrequenciasAudio: function () {
      ...
      var HzPorBarra =
        this.Audio.AudioContext.sampleRate / this.Audio.Analizador.fftSize;
    ...
    IniciarTransicionesBotones: function () {
      ...
      this.C_Atras.Ani = this.Animaciones.CrearTransicion(
        [{ Paso: { RG: 0.1 } }, { Paso: { RG: 1 }, Tiempo: 400 }],
        {
          FuncionActualizar: function (Valores) {
            this.PlanoTextura[0].material.color.setRGB(
              Valores.RG,
              Valores.RG,
              0
            );
      ...
      this.C_Play.Ani = this.Animaciones.CrearTransicion(
        ...
        {
          FuncionActualizar: function (Valores) {
            this.PlanoTextura[1].material.color.setRGB(
              Valores.RG,
              Valores.RG,
              0
            );
            this.PlanoTextura[2].material.color.setRGB(
              Valores.RG,
              Valores.RG,
              0
            );
      ...
      this.C_Adelante.Ani = this.Animaciones.CrearTransicion(
        ...
        {
          FuncionActualizar: function (Valores) {
            this.PlanoTextura[3].material.color.setRGB(
              Valores.RG,
              Valores.RG,
              0
            );
    ...
    IniciarTransiciones: function () {
      ...
      this.BarrasAnalizador.Ani = this.Animaciones.CrearTransicion(
        ...
        {
          FuncionActualizar: function (Valores) {
            this.BarrasAnalizador.scale.set(
              Valores.Escala,
              Valores.Escala,
              Valores.Escala
            );
    ...
    IniciarDatosCancion: function () {
      ...
      this.TexturaDatosCancion = new THREE.Texture(
        this.BufferDatosCancion.Canvas
      );
      this.DatosCancion = new THREE.Mesh(
        new THREE.PlaneGeometry(64, 16),
        new THREE.MeshStandardMaterial({
          map: this.TexturaDatosCancion,
          transparent: true,
          roughness: 0.5,
        })
      );
    ...
    PintarDatosCancion: function (Grupo, Nombre, Año) {
      this.BufferDatosCancion.Context.clearRect(
        0,
        0,
        this.BufferDatosCancion.Ancho,
        this.BufferDatosCancion.Alto
      );
      this.BufferDatosCancion.Context.font = "64px Georgia";
      this.BufferDatosCancion.Context.fillStyle =
        "#" + this.Colores.SombraTexto.getHexString();
      ...
      this.BufferDatosCancion.Context.fillStyle =
        "#" + this.Colores.Texto.getHexString();
    ...
    IniciarPantalla: function () {
      ...
      this.BufferPantalla.Textura = new THREE.Texture(
        this.BufferPantalla.Canvas
      );
      this.Pantalla = new THREE.Mesh(
        new THREE.PlaneGeometry(64, 32),
        new THREE.MeshStandardMaterial({
          map: this.BufferPantalla.Textura,
          roughness: 0.5,
          metalness: 0.73,
          transparent: true,
          opacity: 0.7,
      ...
      this.BufferPantalla2.Textura = new THREE.Texture(
        this.BufferPantalla2.Canvas
      );
      this.Pantalla2 = new THREE.Mesh(
        new THREE.PlaneGeometry(64, 32),
        new THREE.MeshStandardMaterial({
          map: this.BufferPantalla2.Textura,
          roughness: 0.5,
          metalness: 1.0,
          transparent: true,
          opacity: 0.7,
      ...
      this.BufferPantalla3.Textura = new THREE.Texture(
        this.BufferPantalla3.Canvas
      );
      this.Pantalla3 = new THREE.Mesh(
        new THREE.PlaneGeometry(64, 32),
        new THREE.MeshStandardMaterial({
          map: this.BufferPantalla3.Textura,
          roughness: 0.5,
          metalness: 1.0,
          transparent: true,
          opacity: 0.7,
    ...
    PintarPantalla_OndaSin: function (Buffer, Tick) {
      ...
      Buffer.Context.strokeStyle =
        "rgb(" +
        Math.round(128 + this.MediaAudio[4]) +
        "," +
        Math.round(255 - this.MediaAudio[4]) +
        ", 0)";
      var Tam = 1024;
      if (this.Audio.Analizador) {
        Tam = this.Audio.Analizador.fftSize / 2;
      }
    ...
    PintarPantalla_Solar: function (Buffer, Tick) {
      ...
      var TamBuffer = 1024;
      if (this.Audio.Analizador) {
        TamBuffer = this.Audio.Analizador.fftSize / 2;
      }
      ...
      var ColG =
        "rgb(" +
        Math.round(120 + this.MediaAudio[0]) +
        "," +
        Math.round(255 - this.MediaAudio[0]) +
        ", 0)";
      ...
      var ColA =
        "rgb(0, " +
        Math.round(120 + this.MediaAudio[2]) +
        "," +
        Math.round(128 - this.MediaAudio[2]) +
        ")";
      ...
      Buffer.Context.lineTo(
        mx + Math.cos(Tick) * (90 + Valor),
        my + Math.sin(Tick) * (90 + Valor)
      );
    ...
    ActualizarObjetoHover: function () {
      if (this.MouseMovido === true) {
        ...
        for (var i = 0; i < intersects.length; i++) {
          ...
          if (intersects[i].object === this.Pantalla) {
            HoverP = true;
            break;
          }
          if (intersects[i].object === this.Pantalla2) {
            HoverP2 = true;
            break;
          }
          if (intersects[i].object === this.Pantalla3) {
            HoverP3 = true;
            break;
          }
          if (intersects[i].object === this.SueloAnalizador) {
            HoverBarras = true;
            break;
          }
          if (intersects[i].object.parent === this.BarrasAnalizador) {
            HoverBarras = true;
            break;
          }
          if (intersects[i].object === this.Controles) {
            HoverC = true;
          } // El panel de controles tiene botones dentro..
          if (intersects[i].object === this.C_Atras) {
            HoverCAtras = true;
          }
          if (intersects[i].object === this.C_Play) {
            HoverCPlay = true;
          }
          if (intersects[i].object === this.C_Adelante) {
            HoverCAdelante = true;
          }
          if (intersects[i].object === this.DatosCancion) {
            HoverDatosCancion = true;
          }
          ...
          if (intersects[i].object === this.C_BarraTiempo) {
            ...
            //                    console.log(intersects[i].point);
            this.C_BarraTiempo.PosHover =
              intersects[i].point.x + this.AnchoBarraTiempo / 2;
          }
        }
        ...
        if (this.C_Play.Hover !== HoverCPlay) {
          ...
          if (this.C_Play.Ani) {
            this.C_Play.Ani.Transicion();
          }
        }

        if (this.C_Adelante.Hover !== HoverCAdelante) {
          this.C_Adelante.Hover = HoverCAdelante;
          if (this.C_Adelante.Ani) {
            this.C_Adelante.Ani.Transicion();
          }
        }
    ...
    Pintar: function () {
      ...
      this.FuncionesPintarPantalla[this.TipoPantalla](
        this.BufferPantalla,
        this.Tick
      );
      this.FuncionesPintarPantalla[this.TipoPantalla2](
        this.BufferPantalla2,
        this.Tick + 6000
      );
      this.FuncionesPintarPantalla[this.TipoPantalla3](
        this.BufferPantalla3,
        this.Tick + 12000
      );
...
var EspectroAudible_Audio = function () {
  this.Iniciar = function (EsMovil, Padre, FuncionCanPlay, FuncionEnded) {
    ...
    if (EsMovil === true) {
      ...
      R = 1;
    } // Para movil la verión de 256 columnas
    else {
    ...
    this.Canciones = [
      {
        Grupo: "JT Bruce",
        Titulo: "Battle Trance",
        Año: "2015",
        Path: "BattleTrance.mp3",
        Web: "https://www.jamendo.com/track/1237162/battle-trance",
      },
      {
        Grupo: "Fallen to Flux",
        Titulo: "One Chance",
        Año: "2014",
        Path: "OneChance.mp3",
        Web: "https://www.jamendo.com/track/1155241/one-chance",
      },
      {
        Grupo: "From Sky to Abyss",
        Titulo: "Quantum Ocean",
        Año: "2016",
        Path: "QuantumOcean.mp3",
        Web: "https://www.jamendo.com/track/1284951/quantum-ocean",
      },
      {
        Grupo: "In Camera",
        Titulo: "Nothing's Over",
        Año: "2016",
        Path: "In_Camera_-_Nothing_s_Over.mp3",
        Web: "https://www.jamendo.com/track/1397271/nothing-s-over",
      },
      {
        Grupo: "LevenRain",
        Titulo: "ActionMan Versus The CyberParasites",
        Año: "2016",
        Path: "LevenRain_-_ActionMan_Versus_The_CyberParasites.mp3",
        Web: "https://www.jamendo.com/track/1349290/actionman-versus-the-cyberparasites",
      },
      {
        Grupo: "Convergence",
        Titulo: "Six Feet Under",
        Año: "2007",
        Path: "Convergence_-_Six_feet_under.mp3",
        Web: "https://www.jamendo.com/track/80122/six-feet-under",
      },
    ];

    // Enlazo el evento drop del body para poder arrastrar y soltar canciones.
    Padre.Canvas.addEventListener("dragenter", function (e) {
      return false;
    });
    Padre.Canvas.addEventListener("dragover", function (e) {
      return e.preventDefault();
    });

    Padre.Canvas.addEventListener(
      "drop",
      function (e) {
  ...
  this.CargarCancion = function (PosCancion) {
    ...
    this.Cancion.src =
      "https://cdn.rawgit.com/devildrey33/devildrey33/ddb01d71/Ejemplos/BannerTest/Canciones/" +
      this.Canciones[PosCancion].Path;
    this.Cancion.addEventListener("canplay", this.CanPlay.bind(this));
    this.Cancion.addEventListener(
      "ended",
      function () {
        this.FuncionEnded();
      }.bind(this)
  ...
  this.Adelante = function () {
    this.Cancion.pause();
    var p = 0;
    this.CancionActual + 1 < this.Canciones.length
      ? (p = this.CancionActual + 1)
      : (p = 0);
  ...
  this.Atras = function (FuncionCanPlay, FuncionEnded) {
    this.Cancion.pause();
    var p = 0;
    this.CancionActual - 1 > -1
      ? (p = this.CancionActual - 1)
      : (p = this.Canciones.length - 1);
    this.CargarCancion(p);
  };
};
